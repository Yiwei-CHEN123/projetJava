...
public class TacheMassive extends Taches {
    ...
    public TacheMassive(int numTache, String nomTache, String description, String adresseTache, String paysTache, Date dateDeb, Date dateFin, int delaisPrevu, float prix, int nbrPersonne, EtatTache etat, Client client, HashMap<Intervenant, Livraison> lstIntervenantLiv, HashMap<Domaine, ArrayList<Competence>> hmDoCo) {
